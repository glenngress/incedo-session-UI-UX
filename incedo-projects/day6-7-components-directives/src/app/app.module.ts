...
@NgModule({
  declarations: [ //here we need to register component directive pipe
    ...
    AppComponent, MyNewComponentComponent, TestPipePipe, SecondComponentComponent, HighlightDirectiveDirective, HomeComponentComponent, ContactUsComponentComponent, CustomerFormComponent, AnalysisComponent
  ],
